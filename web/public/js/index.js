	...
	$.get('/contract/contract_data.json', function (data, status) {
		if (status === 'success') {
			...
			$('.submit-btn-user-verify').click(function () {
				...
				const isVerified =
					$(this).attr('id') === 'submit-user-verify-accept'
						? true
						: false;
			...
			$('.submit-btn-land-verify').click(function () {
				...
				const purchasepurchaseEpoch = $(
					'#purchaseEpoch-land-verify'
				).val();

				const isVerified =
					$(this).attr('id') === 'submit-land-verify-accept'
						? true
						: false;
			...
			$('.submit-btn-land-avail').click(function () {
				const status =
					$(this).attr('id') === 'submit-land-avail-avail'
						? true
						: false;
